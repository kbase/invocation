...
our @command_groups = (
   ...
   { name => 'registry', title => 'Registry Service Scripts', items => [
	{ cmd => 'register_service', link => '' },
   ]},
   ...
   { name => 'ws', title => 'Workspace Service Scripts', items => [
   ...
   { name => 'plant_ex', title => 'Plant Expression Service Scripts', items => [
	{ cmd => 'getAllEO', link => '' },
	{ cmd => 'getAllPO', link => '' },
	{ cmd => 'getEODescriptions', link => '' },
	{ cmd => 'getEOSampleIDList', link => '' },
	{ cmd => 'getExperimentsBySampleID', link => '' },
	{ cmd => 'getExperimentsBySampleIDnGeneID', link => '' },
	{ cmd => 'getExperimentsBySeriesID', link => '' },
	{ cmd => 'getPODescriptions', link => '' },
	{ cmd => 'getPOSampleIDList', link => '' },
	{ cmd => 'getRepIDBySampleID', link => '' },
	{ cmd => 'get_all_eo', link => '' },
	{ cmd => 'get_all_po', link => '' },
