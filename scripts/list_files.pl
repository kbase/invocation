...
Example:
    ...
    list_files [arguments] < input > output
...
This script is a wrapper for the CDMI-API call list_files. It is documented as follows:
...
my $usage = "usage: list_files [-c column] < input > output";
