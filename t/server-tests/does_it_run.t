...
#
#print "Test 1 :\n";
my $obj = Bio::KBase::InvocationService::Client->new($url);
...
ok(ref($errors) eq 'ARRAY',"Run Pipeline errors is an array");
print Dumper($errors);
#ok(defined($stdweb),"Run Pipeline stdweb is defined");
#ok($stdweb ne '',"Run Pipeline stdweb is not an empty string");
